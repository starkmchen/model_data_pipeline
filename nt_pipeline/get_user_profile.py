...
if __name__ == '__main__':
  ...
  date_str = sys.argv[1]
  df_app_sql1 = "select beyla_id, action_type, app_list from sprs_ad_dwd.user_app_list_temp where dt = '%s'" % (date_str)
  ...
  df_base_sql = "select beyla_id, coalesce(age, '') as age, coalesce(gender, '') as gender, \
      ...
      from sprs_ad_dwd.user_profile_temp"
  ...
  rdd.saveAsTextFile("s3://sprs.push.us-east-1.prod/data/warehouse/model/user_profile/%s" % (date_str))
