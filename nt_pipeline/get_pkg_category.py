...
if __name__ == '__main__':
  spark = SparkSession.builder.appName('get_pkg_info').enableHiveSupport().getOrCreate()
  date_str = sys.argv[1]
  ...
  rdd.saveAsTextFile('s3://sprs.push.us-east-1.prod/data/warehouse/model/pkg_info/%s' % (date_str))
